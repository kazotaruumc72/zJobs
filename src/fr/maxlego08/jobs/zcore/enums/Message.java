...
public enum Message {
    ...
    DESCRIPTION_ADMIN_BOOST("Show admin boost commands"),
    DESCRIPTION_ADMIN_BOOST_CREATE("Create a boost"),
    DESCRIPTION_ADMIN_BOOST_SHOW("Show player's boosts"),
    DESCRIPTION_ADMIN_BOOST_REMOVE("Remove a boost"),
